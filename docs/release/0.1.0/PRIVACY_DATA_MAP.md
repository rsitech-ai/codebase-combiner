...
| Preferences                  | user settings                                | Preserve filters/layout choices       | UserDefaults until manually reset or removed                        | None                                   | Manual settings/container removal; uninstall is not guaranteed to delete local data |
