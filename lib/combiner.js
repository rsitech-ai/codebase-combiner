...
function suggestedOutputFileName(configuredName, outputFormat) {
  const safeName = safeOutputFileName(configuredName);
  if (safeName === 'combined_code.txt' && outputFormat === 'md') {
    return 'combined_code.md';
  }
  return safeName;
}
